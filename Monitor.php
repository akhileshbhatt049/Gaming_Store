...
<header>
    ...
    <nav>
        ...
        <a href="Monitor.php" class="nav-link active" id="Size">Monitor</a>
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div>
            <a href="Buy_Product.php?id=<?php echo $row['ID']; ?>">
                <img src="<?php echo './' . $row['Product_image']; ?>" alt="Monitor" width="300">
            </a>
    ...
    echo "<p style='color:white; font-size:20px;'>No monitor products available.</p>";
}
?>
