...
<header>
    ...
    <nav>
        ...
        <a href="Chairs.php" class="nav-link active" id="Size">Chair</a>
    </nav>
</header>
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div>
            <a href="Buy_Product.php?id=<?php echo $row['ID']; ?>">
                <img src="<?php echo './' . $row['Product_image']; ?>" alt="Chair" width="300">
            </a>
    ...
    echo "<p style='color:white; font-size:20px;'>No chair products available.</p>";
}
?>
