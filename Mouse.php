...
<header>
    ...
    <nav>
        ...
        <a href="Mouse.php" class="nav-link active" id="Size">Mouse</a>
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div>
            <a href="Buy_Product.php?id=<?php echo $row['ID']; ?>">
                <img src="<?php echo './' . $row['Product_image']; ?>" alt="Mouse" width="300">
            </a>
    ...
    echo "<p style='color:white; font-size:20px;'>No mouse products available.</p>";
}
?>
